...
best_model_name = r'C:\Users\Y2LabServer4\downloads\ipynb_checkpoints\ipynb_checkpoints\20231018_best_metric_model.pth'
...
post_trans = Compose([EnsureType(data_type='tensor'), AsDiscrete(threshold=7)]) 
